...
const styles = StyleSheet.create({
    ...
    bgGlow: { position: 'absolute', width: 350, height: 350, borderRadius: 175, backgroundColor: '#6C63FF', opacity: 0.1, top: -120, alignSelf: 'center' },
    ...
    logoRing: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#000', overflow: 'hidden', borderWidth: 1.5, borderColor: 'rgba(108,99,255,0.5)', marginBottom: Spacing.xl },
    logoImg: { width: 80, height: 80 },
    title: { fontSize: 34, fontWeight: '900', color: '#fff', marginBottom: Spacing.sm },
    subtitle: { fontSize: FontSize.md, color: 'rgba(255,255,255,0.5)' },
    ...
    inputRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.07)', borderRadius: BorderRadius.xl, paddingHorizontal: Spacing.lg, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', minHeight: 54 },
    inputIcon: { marginRight: Spacing.md },
    textInput: { flex: 1, fontSize: FontSize.md, color: '#fff', paddingVertical: Spacing.md },
    forgotBtn: { alignSelf: 'flex-end' },
    forgotText: { fontSize: FontSize.sm, color: '#6C63FF', fontWeight: '600' },
    loginBtn: { backgroundColor: '#6C63FF', borderRadius: BorderRadius.pill, paddingVertical: 18, alignItems: 'center', marginBottom: Spacing.xl, shadowColor: '#6C63FF', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.4, shadowRadius: 12, elevation: 6 },
    loginBtnText: { color: '#fff', fontSize: FontSize.lg, fontWeight: '800' },
    signupLink: { alignItems: 'center', marginBottom: Spacing.xxl },
    signupText: { fontSize: FontSize.md, color: 'rgba(255,255,255,0.4)' },
    signupBold: { color: '#6C63FF', fontWeight: '700' },
    ...
    dividerText: { fontSize: FontSize.sm, color: 'rgba(255,255,255,0.3)' },
    socialButtons: { marginBottom: Spacing.xl },
    socialBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: Spacing.md, paddingVertical: 16, borderRadius: BorderRadius.pill, borderWidth: 1 },
    socialBtnText: { fontSize: FontSize.md, fontWeight: '700' },
