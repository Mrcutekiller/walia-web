...
const styles = StyleSheet.create({
    ...
    bgGlow: { position: 'absolute', width: 350, height: 350, borderRadius: 175, backgroundColor: '#6C63FF', opacity: 0.1, top: -100, alignSelf: 'center' },
    safeArea: { flex: 1 },
    ...
    headerLogo: { width: 36, height: 36, backgroundColor: '#000', borderRadius: 18 },
    ...
    progressDotActive: { backgroundColor: 'rgba(108,99,255,0.5)' },
    progressDotCurrent: { backgroundColor: '#6C63FF', width: 48 },
    content: { paddingHorizontal: Spacing.xxl, paddingBottom: Spacing.huge },
    stepLabel: { fontSize: FontSize.xs, color: 'rgba(255,255,255,0.4)', fontWeight: '600', letterSpacing: 1, textTransform: 'uppercase', marginBottom: Spacing.sm },
    title: { fontSize: 32, fontWeight: '800', color: '#fff', marginBottom: Spacing.sm, lineHeight: 38 },
    subtitle: { fontSize: FontSize.md, color: 'rgba(255,255,255,0.5)', marginBottom: Spacing.xxl, lineHeight: 22 },
    fields: { gap: Spacing.md },
    darkInput: { backgroundColor: 'rgba(255,255,255,0.07)', borderColor: 'rgba(255,255,255,0.1)', borderRadius: BorderRadius.xl },
    darkLabel: { color: 'rgba(255,255,255,0.6)' },
    darkInputText: { color: '#fff' },
    chipGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: Spacing.md },
    chip: { borderRadius: BorderRadius.pill, borderWidth: 1.5, borderColor: 'rgba(255,255,255,0.15)', paddingHorizontal: Spacing.xl, paddingVertical: Spacing.md, backgroundColor: 'rgba(255,255,255,0.05)' },
    chipActive: { borderColor: '#6C63FF', backgroundColor: 'rgba(108,99,255,0.2)' },
    chipText: { fontSize: FontSize.md, color: 'rgba(255,255,255,0.6)' },
    chipTextActive: { color: '#fff', fontWeight: '700' },
    goalGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: Spacing.md },
    goalCard: { width: '47%', backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: BorderRadius.xl, padding: Spacing.xl, borderWidth: 1.5, borderColor: 'rgba(255,255,255,0.1)', alignItems: 'center', gap: Spacing.sm },
    goalCardActive: { borderColor: '#6C63FF', backgroundColor: 'rgba(108,99,255,0.2)' },
    goalEmoji: { fontSize: 32 },
    goalLabel: { fontSize: FontSize.sm, color: 'rgba(255,255,255,0.6)', textAlign: 'center', fontWeight: '600' },
    goalLabelActive: { color: '#fff' },
    avatarPickerSection: { alignItems: 'center', paddingTop: Spacing.xl },
    avatarMain: { width: 140, height: 140, borderRadius: 70, backgroundColor: 'rgba(255,255,255,0.05)', borderWidth: 2, borderColor: 'rgba(108,99,255,0.3)', alignItems: 'center', justifyContent: 'center', position: 'relative' },
    avatarEdit: { width: 136, height: 136, borderRadius: 68 },
    avatarPlaceholder: { alignItems: 'center', gap: Spacing.xs },
    avatarPlaceholderText: { color: 'rgba(255,255,255,0.4)', fontSize: FontSize.sm, fontWeight: '600' },
    editBadge: { position: 'absolute', bottom: 5, right: 5, width: 34, height: 34, borderRadius: 17, backgroundColor: '#6C63FF', alignItems: 'center', justifyContent: 'center', borderWidth: 3, borderColor: '#0A0A18' },
    avatarHint: { fontSize: FontSize.sm, color: 'rgba(255,255,255,0.4)', textAlign: 'center', marginTop: Spacing.xxl, paddingHorizontal: Spacing.xl, lineHeight: 20 },
    footer: { paddingHorizontal: Spacing.xxl, paddingBottom: Spacing.xl, gap: Spacing.md },
    nextBtn: { backgroundColor: '#6C63FF', borderRadius: BorderRadius.pill, paddingVertical: 18, alignItems: 'center', shadowColor: '#6C63FF', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.4, shadowRadius: 12, elevation: 6 },
    nextBtnDisabled: { backgroundColor: 'rgba(108,99,255,0.3)', shadowOpacity: 0 },
    nextBtnText: { color: '#fff', fontSize: FontSize.lg, fontWeight: '800' },
    signinLink: { alignItems: 'center' },
    signinText: { fontSize: FontSize.md, color: 'rgba(255,255,255,0.4)' },
    signinBold: { color: '#6C63FF', fontWeight: '700' },
});
